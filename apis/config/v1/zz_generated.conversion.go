...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetworkAwareDynamicArgs)(nil), (*config.NetworkAwareDynamicArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NetworkAwareDynamicArgs_To_config_NetworkAwareDynamicArgs(a.(*NetworkAwareDynamicArgs), b.(*config.NetworkAwareDynamicArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NetworkAwareDynamicArgs)(nil), (*NetworkAwareDynamicArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetworkAwareDynamicArgs_To_v1_NetworkAwareDynamicArgs(a.(*config.NetworkAwareDynamicArgs), b.(*NetworkAwareDynamicArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ScoreByLabelArgs)(nil), (*config.ScoreByLabelArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ScoreByLabelArgs_To_config_ScoreByLabelArgs(a.(*ScoreByLabelArgs), b.(*config.ScoreByLabelArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ScoreByLabelArgs)(nil), (*ScoreByLabelArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ScoreByLabelArgs_To_v1_ScoreByLabelArgs(a.(*config.ScoreByLabelArgs), b.(*ScoreByLabelArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_NetworkAwareDynamicArgs_To_config_NetworkAwareDynamicArgs(in *NetworkAwareDynamicArgs, out *config.NetworkAwareDynamicArgs, s conversion.Scope) error {
	out.Namespaces = *(*[]string)(unsafe.Pointer(&in.Namespaces))
	out.Address = in.Address
	out.Port = in.Port
	out.TimeRangeInMinutes = in.TimeRangeInMinutes
	out.WeightLatency = in.WeightLatency
	out.WeightForwardBytes = in.WeightForwardBytes
	out.WeightDropBytes = in.WeightDropBytes
	return nil
}

// Convert_v1_NetworkAwareDynamicArgs_To_config_NetworkAwareDynamicArgs is an autogenerated conversion function.
func Convert_v1_NetworkAwareDynamicArgs_To_config_NetworkAwareDynamicArgs(in *NetworkAwareDynamicArgs, out *config.NetworkAwareDynamicArgs, s conversion.Scope) error {
	return autoConvert_v1_NetworkAwareDynamicArgs_To_config_NetworkAwareDynamicArgs(in, out, s)
}

func autoConvert_config_NetworkAwareDynamicArgs_To_v1_NetworkAwareDynamicArgs(in *config.NetworkAwareDynamicArgs, out *NetworkAwareDynamicArgs, s conversion.Scope) error {
	out.Namespaces = *(*[]string)(unsafe.Pointer(&in.Namespaces))
	out.Address = in.Address
	out.Port = in.Port
	out.TimeRangeInMinutes = in.TimeRangeInMinutes
...
// Convert_config_NetworkAwareDynamicArgs_To_v1_NetworkAwareDynamicArgs is an autogenerated conversion function.
func Convert_config_NetworkAwareDynamicArgs_To_v1_NetworkAwareDynamicArgs(in *config.NetworkAwareDynamicArgs, out *NetworkAwareDynamicArgs, s conversion.Scope) error {
	return autoConvert_config_NetworkAwareDynamicArgs_To_v1_NetworkAwareDynamicArgs(in, out, s)
}
...
func autoConvert_v1_ScoreByLabelArgs_To_config_ScoreByLabelArgs(in *ScoreByLabelArgs, out *config.ScoreByLabelArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_string_To_string(&in.LabelKey, &out.LabelKey, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_ScoreByLabelArgs_To_config_ScoreByLabelArgs is an autogenerated conversion function.
func Convert_v1_ScoreByLabelArgs_To_config_ScoreByLabelArgs(in *ScoreByLabelArgs, out *config.ScoreByLabelArgs, s conversion.Scope) error {
	return autoConvert_v1_ScoreByLabelArgs_To_config_ScoreByLabelArgs(in, out, s)
}

func autoConvert_config_ScoreByLabelArgs_To_v1_ScoreByLabelArgs(in *config.ScoreByLabelArgs, out *ScoreByLabelArgs, s conversion.Scope) error {
	if err := metav1.Convert_string_To_Pointer_string(&in.LabelKey, &out.LabelKey, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_ScoreByLabelArgs_To_v1_ScoreByLabelArgs is an autogenerated conversion function.
func Convert_config_ScoreByLabelArgs_To_v1_ScoreByLabelArgs(in *config.ScoreByLabelArgs, out *ScoreByLabelArgs, s conversion.Scope) error {
	return autoConvert_config_ScoreByLabelArgs_To_v1_ScoreByLabelArgs(in, out, s)
}
